...
Core theory been caried into evolutionary computation from Geiringer's theorem --- which establishes that under recombination a population converges to linkage equillibrium, with no correlation between allele co-occurence \citep{geiringer1944probability}.
