...
From classical population genetics, the ``strength of selection" reflects the interplay between differences in fitness and random fluctuations in allele frequencies over generations (\textit{i.e.}, genetic drift) due to finite population sizes in natural populations \citep{lynch2016genetic, kimura1985theb, ohta1992thec}.
...
For instance, selection pressures may be explicitly designed to favor candidate solutions that not only achieve high task performance but also demonstrate behavioral or structural novelty in their problem-solving strategies \citep{mouret2015illuminating,lehman2011evolvingc}.
...
Likewise, an algorithmic protocol ill-suited for the underlying landscape---such as one that aggressively prioritizes high-performing individuals in a search space containing numerous local optima---can degrade search performance \citep{mouret2015illuminating,helmuth2015solvingb,lehman2011evolvingc}.
...
In contrast, weak selection pressure can lead to deleterious trait accumulation, via Muller's \citep{muller1964the, haigh1978the} and/or Ohta's Ratchet \citep{ohta1973slightly, ohta1992thec}, and inadequate optimization of beneficial traits in natural systems \citep{lynch2016genetic,lahti2009relaxed}.
...
Prior work has derived closed-form expressions measuring the selection pressure induced by several widely used selection schemes, providing simplified formulas that clarify their underlying dynamics \citep{blickle1996a,goldberg1991a,back1994selective,lehre2011fitnesslevels}.
...
% Insights into how selection operates in biological systems have strongly influenced both the theory and practice of EC, clarifying the role of population size in performance \citep{chen2012a,witt2008population,piszcz2006genetic,ashlock2006using,luke2003population,hu2009the}, and motivating the development of increasingly sophisticated selection mechanisms \citep{lehman2011evolvingc,mouret2015illuminating,helmuth2015solvingb,deb2002a}.
