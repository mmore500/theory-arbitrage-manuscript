...
Though evolution progresses most efficiently on an adaptive landscape that is monotonic and smooth, in practice such conditions are rare.
Instead, adaptive landscapes typically exhibit \textit{rugedness} \citep{papkou2023rugged,reidys2001neutrality} and \textit{neutrality} (or near-neutrality) \citep{kimura1983neutral,kimura1991neutral,ohta1992nearly,ohta2002near}.
Such features can impede adaptive evolution by hampering the discovery of beneficial mutations \citep{martin2013multiple,steinberg2016environmental,li2025probability,bank2022epistasis,neidhart2014adaptation,orr2005genetic,bershtein2008advances,van1999neutral}.
Although counteracted somewhat by high dimensionality of genotype space \citep{franke2011evolutionary}, something under drift \citep{reidys2001neutrality,ahnert2017structural,croitoru2022punctuated,galvanlopez2011neutrality,jorg2008neutral,huynen1996smoothness,shackleton2000investigation,huynen1996exploring,amitai2007latent,banzhaf2006evolution,hu2025neutrality,oliveto2017how,wagner2008robustness,wagner2013robustness,masel2010robustness,hu2018neutrality}, and the possibility of far-reaching jumps between mutational neighborhoods in systems with recombination processes \citep{li2024rapid,doerr2008crossover,fogel1994effectiveness} --- such geometry nonetheless inhibits evolution in important ways.

Indeed, this adaptive landscape perspective draws into question a necessary axiom of evolution: the capability of a population to generate adaptive genetic variation \citep{TODO}.
Interest in this topic has coalesced under a broad umbrella term of ``evolvability'' \citep{payne2018causes,kirschner1998evolvability}.
\unskip\footnote{%
In addition to the adaptive landscape, discussion on evolvability has also included broader considerations like population genetics (e.g., standing diversity) \citep{TODO}.
}
...
whereas in biology it is more often conceptualized as local more navigable structure of the fitness landscape with respect to available mutations \citep{wagner2017information,wagner2023evolvability}.
In evolutionary computation, a more global is taken In evolutionary computation, properties of the genotype-phenotype map that produce a more navigable genotype space.
Given these disparate perspectives, biologists and evolutionary computation practitioners have a lot to learn from eachother, and already have.
We will now review these perspectives, and highlight opportunities realized and unrealized for further discussion.
