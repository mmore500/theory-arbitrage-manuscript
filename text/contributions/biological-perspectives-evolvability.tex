...
A fundamental property differentiating evolution from random search is mutational locality, the tendency for a mutant to resemble its parent \citep{maynardsmith1970natural,galvanlopez2011defining,ashlock2012representation,back1996evolutionary,foster2001evolutionary,richter2014fitness}.
This property depends on the geometry of genotype space --- the set of all possible genetic sequences, arranged by mutational neighborhood \citep{fragata2019evolution,castle2021towards}.
...
A second fundamental prerequisite of evolution by natural selection is variation in fitness between points in genotype space, which bias the trajectories of populations under mutation --- creating a so-called ``fitness landscape'' (Figure \ref{fig:fitness_landscapes}, middle).
In scenarios where fitness values may change over time (e.g., depending on ecological or environmental factors \citep{olson2014dynamic,kaplan2008end,dolson2021digital}), such a fitness landscape may instead be termed a``fitness seascape'' \citep{cairns2022strong,mustonen2009fitness}.
In the face of such fitness volatility, another useful abstraction genotype-phenotype map \citep{ahnert2017structural,aguilar2018architecture,stadler2003landscapes}.
As a biological phenotype (observable traits) can often be more readily and consistently measured than fitness, it often provides a more tractable target for study \citep{chen2022environmental,ahnert2017structural,wagner2011pleiotropic,aguilar2018architecture}.
...
Much of the terminology used to describe the evolutionary characteristics of an adaptive landscape are shared in common between EC and evolutionary biology.
A key property of an adaptive landscape is its ``rugedness'' \citep{papkou2023rugged,reidys2001neutrality} --- the extent to which ``peaks'' and ``valleys'' arise that constrain evolutionary exploration \citep{martin2013multiple,steinberg2016environmental,li2025probability,bank2022epistasis,neidhart2014adaptation,orr2005genetic,bershtein2008advances}.
Another property of interest in mutational landscapes is ``neutrality'' --- the availability of mutations that produce no, or negligible, effect \citep{kimura1983neutral,kimura1991neutral,ohta1992nearly,ohta2002near}.
While such neutrality can inhibit short-term discovery of phenotypic variation \citep{van1999neutral,TODO}, it can also promote exploration and long-term innovations by allowing TODO \citep{reidys2001neutrality,ahnert2017structural,croitoru2022punctuated,galvanlopez2011neutrality,jorg2008neutral,huynen1996smoothness,shackleton2000investigation,huynen1996exploring,amitai2007latent,banzhaf2006evolution,hu2025neutrality,oliveto2017how,wagner2008robustness,wagner2013robustness,masel2010robustness,hu2018neutrality}.
The high dimensionality of genotype space \citep{franke2011evolutionary} and possibility of far-reaching jumps between mutational neighborhoods may occur in systems with recombination processes \citep{li2024rapid,doerr2008crossover,fogel1994effectiveness} can also help escape local optima.

Despite common interest and vocabulary, EC and biology diverge on the topic of evolvability.
TODO introduce evolvability and section and can save.
...
\subsection{Evolvability Opportunities}
