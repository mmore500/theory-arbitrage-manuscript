% dead source file, edit main/diversity-maintenance.tex instead
% Emily
...
Both selection strength and spatial structure have thus long been of interest within evolutionary computation with respect to diversity maintenance \citep{simon2008biogeographybased,blickle1995comparison}.
...
Extending this strategy to also promote divergence from cumulative population history provides the basis of novelty search and its related variants \citep{lehman2011abandoning,pugh2016quality,lehman2011evolving}.
Ecological interactions have also been mediated by resource competition (e.g., EcoEA \citep{goings2009ecological,goings2012ecologybased}) or by partitioning capacity across habitat gradients (e.g., quality-diversity \citep{mouret2015illuminating,cully2018quality}).
While ecological in the sense of predicating fitness on population composition, other diversity maintenance schemes have no biological analog --- such as lexicase selection and its variants, which select on heterogeneous combinations of traits \citep{spector2012assessment,ferguson2020characterizing,boldi2024informed,lacava2016epsilonlexicase}.
Other more artificial approaches to promoting diversity include runtime applications of ancestry information \citep{burlacu2019online,gabor2018inheritancebased,gabor2018preparing,burke2003increased,lalejini2024phylogenyinformed,lalejini2024runtime,murphy2008simple,burlacu2023population}.
...
In the late 1980s, researchers in theoretical ecology \citep{chesson1990macarthur} and evolutionary computation \citep{deb1989investigation} independently derived equivalent math while trying to predict when coexistence would occur in their respective systems \citep{dolson2018ecological}.
Similar mathematical equivalencies can be found in other evolutionary algorithms \citep{dolson2018ecological}.
Once these equivalencies are identified, large bodies of existing ecological theory can be immediately applied to the relevant evolutionary algorithm.
For example, \citet{deb1989investigation} only derived the math to predict when two species/solutions would coexist indefinitely.
Ecologists, however, have gone on to derive math for multi-species coexistence in the same scenario (in addition to a variety of more complex scenarios that may or may not translate usefully to evolutionary computation) \citep{barabas2016multispecies,saavedra2017structural,chesson2000mechanisms}.
...
Recently, it has been shown that this approach can be applied to predicting the possible trajectories of evolutionary computation as well \citep{dolson2024reachability}.
...
% \item \citet{shahbandegan2024robustness} robustness of lexicase selection to contradictory objectives
...
% \item EcoEA \citet{goings2012ecologybased}
% \item novelty search and friends \citet{lehman2011abandoning,pugh2016quality,lehman2011evolving}
