...
In evolutionary computation, exploration is achieved by maintaining a diverse population \citep{sudholt2019the}.
...
Likewise, existing evolutionary graph theory describes how spatial structure can influence the probability of mutations fixing within a population \citep{lieberman2005evolutionaryc}, and slow the rate at which fixation occurs \citep{frean2013the}.
Both selection strength and spatial structure have thus long been of interest within evolutionary computation
with respect to diversity maintenance \citep{simon2008biogeographybased, blickle1995a}.

Although diversity loss can be slowed by spatial structure and large population size \citep{slatkin1981fixation, kimura1969the}, even under fully neutral selection, most lineages will eventually be driven extinct by drift effects \citep{wright1931evolutionb, fisher1930theb, kingman1982thec}.
...
In ecology, such balancing is typically framed in terms of negative frequency-dependent selection (scenarios where rare traits are advantaged) \citep{brisson2018negative, clarke1979the, wright1939the, levin1988frequencydependent}, resource specialization \citep{tilman1980resources}, habitat requirements \citep{grinnell1917the}, and niche occupancy \citep{hutchinson1957concluding}.
...
Classical approaches --- such as crowding, niching, and fitness sharing --- lend favor to candidate solutions on the basis of their rareness and distinctiveness \citep{mahfoud1996niching, petrowski1996a, dejong1975an, friedrich2009analysis}.
Extending this strategy to also promote divergence from cumulative population history provides the basis of novelty search and its related variants \citep{lehman2011abandoning, pugh2016qualityb, lehman2011evolving}.
Ecological interactions have also been mediated by resource competition (e.g., EcoEA \citep{goings2009ecological, goings2012an}) or by partitioning capacity across habitat gradients (e.g., quality-diversity \citep{mouret2015illuminatingb, cully2018quality}).
...
In the late 1980s, researchers in theoretical ecology \citep{chesson1990macarthurs} and evolutionary computation \citep{deb1989an} independently derived equivalent math while trying to predict when coexistence would occur in their respective systems \citep{dolson2018ecological}.
...
For example, \citep{deb1989an} only derived the math to predict when two species/solutions would coexist indefinitely. Ecologists, however, have gone on to derive math for multi-species coexistence in the same scenario (in addition to a variety of more complex scenarios that may or may not translate usefully to evolutionary computation) \citep{barabas2016the, saavedra2017a, chesson2000mechanisms}. 
...
For example, community assembly graphs are a framework for predicting the possible trajectories of ecological community assembly (i.e., the process of species getting added to a community) \citep{hangkwang1993the, servn2021tractable}.
...
More than just borrowing from ecological theory, however, evolutionary computation has also contributed meaningfully as a tractable study system that is controlled, and fully observable yet also nontrivial \citep{dolson2021digitalc}.
Likewise, EC selection schemes provide promising means for objective-oriented structuring of artificial ecologies in directed and experimental evolution of biological organisms under laboratory conditions \citep{lalejini2022artificialc}.
...
% \item a spatial heuristic for ecology \citet{simon2008biogeographybased}
% \item move citations incorporated into section text here!
% \item \citet{mouret2015illuminatingb} map-elites
% \item \citet{friedrich2009analysis}
% \item \citet{dolson2018applyingb}
% \item \citet{dolson2018ecologicalb}
% \item \citet{deb1989an}
% \item \citet{dolson2024reachabilityb}
% \item digital evolution for ecology review \citet{dolson2021digitalc}
% \item EcoEA \citet{goings2012an}
% \item novelty search and friends \citet{lehman2011abandoning, pugh2016qualityb, lehman2011evolving}
% \item NEAT speciation \citet{stanley2002evolvingb}
% \item artificial selection schemes for directed evolution \citet{lalejini2022artificialc}
% \item \citet{sudholt2019the}
% \end{itemize}
