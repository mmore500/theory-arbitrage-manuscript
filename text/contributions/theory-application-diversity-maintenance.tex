...
In evolutionary computation, exploration is achieved by maintaining a diverse population \citep{Sudholt2019}.
Over the years, key innovations in evolutionary computation have come from discovering better diversity maintenance techniques \citep{goldberg_genetic_1987, wang2019poet}. 
...
with respect to diversity maintenance \citep{Simon2008,blickle:1995:css}.

Although diversity loss can be slowed by spatial structure and large population size \citep{Slatkin1981,Kimura1969}, even under fully neutral selection, most lineages will eventually be driven extinct by drift effects \citep{Wright1931evolution,Fisher1930,kingman1982coalescent}.
...
Classical approaches --- such as crowding, niching, and fitness sharing --- lend favor to candidate solutions on the basis of their rareness and distinctiveness \citep{mahfoud1996niching,Petrowski1996,dejong1975analysis,Friedrich2009}.
Extending this strategy to also promote divergence from cumulative population history provides the basis of novelty search and its related variants \citep{Lehman2011,Pugh2016,Lehman2011evolving}.
Ecological interactions have also been mediated by resource competition (e.g., EcoEA \citep{Goings2009,Goings2012}) or by partitioning capacity across habitat gradients (e.g., quality-diversity \citep{Mouret2015,Cully2018}).
...
In the late 1980s, researchers in theoretical ecology \citep{Chesson1990} and evolutionary computation \citep{Deb1989} independently derived equivalent math while trying to predict when coexistence would occur in their respective systems \citep{dolson2018ecological}.
...
For example, \citep{Deb1989} only derived the math to predict when two species/solutions would coexist indefinitely. Ecologists, however, have gone on to derive math for multi-species coexistence in the same scenario (in addition to a variety of more complex scenarios that may or may not translate usefully to evolutionary computation) \citep{barabas2016multispecies,saavedra2017structural,chesson2000mechanisms}. 
...
For example, community assembly graphs are a framework for predicting the possible trajectories of ecological community assembly (i.e., the process of species getting added to a community) \citep{hangkwang1993assembly,servan2021tractable}.
...
More than just borrowing from ecological theory, however, evolutionary computation has also contributed meaningfully as a tractable study system that is controlled, and fully observable yet also nontrivial \citep{Dolson2021}.
Likewise, EC selection schemes provide promising means for objective-oriented structuring of artificial ecologies in directed and experimental evolution of biological organisms under laboratory conditions \citep{Lalejini2022}.
...
% \item MAP-Elites \citet{Dolson2019}
% \item ecological approaches to diversity maintenance in evolutionary algorithms \citet{Goings2009}
% \item \citet{Shahbandegan2024} robustness of lexicase selection to contradictory objectives
% \item \citet{Neumann2019}
% \item \citet{Letten2017}
% \end{itemize}

% \textbf{Included Citations}: \begin{itemize}
% \item a spatial heuristic for ecology \citet{Simon2008}
% \item move citations incorporated into section text here!
% \item \citet{Mouret2015} map-elites
% \item \citet{Friedrich2009}
% \item \citet{Dolson2018a}
% \item \citet{Dolson2018b}
% \item \citet{Deb1989}
% \item \citet{Dolson2024}
% \item digital evolution for ecology review \citet{Dolson2021}
% \item EcoEA \citet{Goings2012}
% \item novelty search and friends \citet{Lehman2011,Pugh2016,Lehman2011evolving}
% \item NEAT speciation \citet{stanley2002neat}
% \item artificial selection schemes for directed evolution \citet{Lalejini2022}
% \item \citet{Sudholt2019}
% \end{itemize}

% \textbf{Excluded Citations}: \begin{itemize}
% \item move citations not incorporated into section text here!
% \item \citet{Sudholt2024}
% \end{itemize}
