...
It may be defined for genotypes (i.e., genetic makeup) or phenotypes (i.e., observable traits), and it is evaluated relative to the population's ecological and demographic context \citep{orr2009fitness}.
...
Such models are common (though not universal) in EC, which typically follows a stable, highly-regular artificial-selection paradigm: users define the objectives of interest, evaluate candidate solutions, and deliberately propagate promising variants to subsequent generations within a controlled computational setting.
