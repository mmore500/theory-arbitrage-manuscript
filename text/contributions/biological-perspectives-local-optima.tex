...
Up to now, the discussion of local optima and premature convergence has centered on population dynamics: how do populations escape from premature convergence? However, there are a number of paths out of a local optimum which might be attributed to the landscape itself.
