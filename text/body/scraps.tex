% while it is true that significant aspects of methodology are specific to the particulars of biology, with creative and substantial tweaks some surprising aspects of biological study can become the genetalizabile.
...
% However, recent work has engineered analogs of reconstruction approaches to achieve highly scalable phylogenetic tracking.
...
% particularly for bio-inspired methods \citep{delser2019bioinspired}.
...
%   \item phylogeny for prediction/analysis \citep{hernandez2022what,shahbandegan2022untangling}
%   \item alife data standards: interoperation with bioinformatics infrastructure \citep{lalejini2019data,moreno2024mmorealifedataphyloinformaticsconvert}
...
% This empiricism-first, descriptive paradigm is like biology. \citep{welch2017whats}.
