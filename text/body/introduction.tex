...
Although some work extends well outside the biological metaphor \citep{hansen2001completely,munteanu1999improving,miller2015cartesian}, core aspects of EC inhabit a bio-inspired framing --- whether because they were originally conceived as such, or because they were subsequently reframed to fit an analog in nature.
Table \ref{tab:bioinspiration} highlights prominent examples of this phenomenon.

\input{tab/bioinspiration.tex}

Indeed, given the prevalence of bio-inspiration within evolutionary computing (EC), the merit of biological metaphors has constituted a longstanding point of discussion.
In addition to arguing that they impart useful new ideas, some highlight value from biological metaphors simply as a source for convenient, intuitive, self-consistent vocabulary \citep{sorensen2015metaheuristicsthe,banzhaf2006fromb}.
Another draw of bio-inspiration is the charisma it lends evolutionary computation \citep{lehman2020the}.
...
Indeed, the demonstrated viability of natural precedent lends bio-inspiration credence as a blueprint for ambitious research agendas in computing \citep{miikkulainen2021a,banzhaf2006from}.

Some have questioned, however, whether charisma of the bio-inspired framing might also be serving as a preoccupying distraction \citep{moore2023is,sorensen2015metaheuristicsthe}.
In particular, given the broader tendency for machine learning researchers to adhere to their preferred models \citep{domingos2012a}, there is risk that evolutionary approaches have become something of a pursuit for its own sake, rather than a means to an end \citep{woodward2016gp,yampolskiy2018why}.
...
%As typical in outcome-driven AI/ML fields, substantial portions of the EC literature pursue descriptive rather than explanatory objectives --- i.e., ``we found that $X$ approach benefited solution quality'' as opposed to ``we evaluated how $Y$ mechanism mediates effects of $X$ approach'' \citep{lipton2019troubling,hutson2018ai,sculley2018winners,delser2019bioinspired}.%
%\footnote{%
...
%However, in the case of evolutionary algorithms, the fact of biological precedent can partially stand in for explanation of how and why a proposed algorithm would have some desirable properties \citep{sorensen2015metaheuristicsthe}.
% Take, for instance, \citep{TODO}.

Moreover, to a skeptical reader, pervasive appeals to bio-inspiration can come across as window dressing on recycled ideas or as an instance of the naturalistic fallacy \citep{wortmann2020does,sorensen2015metaheuristicsthe}.
...
The \textit{ad hoc} nature of evolutionary computation has also been implicated in hindering adoption, on account of numerous configurable and tunable elements confronting new users \citep{oneill2010open}.

One possible response to these concerns is to favor de-emphasizing the evolutionary metaphor, with the goal of deepening and diversifying first principles footing of evolutionary computation \citep{moore2023is}.
...
Historically, evolutionary computation researchers have primarily drawn on bio-inspiration to improve the performance of runtime algorithms \citep{banzhaf2006fromb,kumar2003biologically,mcphee2009developmental}.
...
As we will review, substantial progress has already been made in this vein \citep{hu2010evolvabilityc} --- however, much untapped value remains to be ``arbitraged'' from biological literature.
...
These life sciences fields have seen radical advances in recent years due to technological leaps in data acquisition and analysis capability \citep{math2018the,deshpande2024the}.
...
Indeed, computational artificial life approaches, a close cousin of evolutionary computation, are a popular technique for exploring the generalizability of biological concepts beyond life-as-we-know-it \citep{cleland2013is,langton1989artificial,pennock2007models}. % ELD: Lots more astrobiology citations we could add here
...
Given the vastness, context-dependence, and --- at times --- polyonymy of biological theory, interdisciplinary collaborations can be highly productive \citep{banzhaf2020evolution}.
...
Namely, substantial gaps remain in the explanatory and predictive power of analyses and theory in ecology and evolution \citep{houlahan2016the,catford2022addressing,yates2018outstanding} --- although this is best considered as the exception, rather than the rule \citep{lynch2025complexity}.
Not unlike evolutionary computation, deficiency in theory has habituated perennial consternation in evolutionary biology \citep{welch2017whats}.
