...
In addition to arguing that they impart useful new ideas, some highlight value from biological metaphors simply as a source for convenient, intuitive, self-consistent vocabulary \citep{sorensen2015metaheuristics, banzhaf2006from}.
...
Some have questioned, however, whether charisma of the bio-inspired framing might also be serving as a preoccupying distraction \citep{moore2023is, sorensen2015metaheuristics}.
...
Failures to recognize and build on existing work have also been broadly highlighted \citep{lynch2025complexity, beer2024life}.
