...
Moreover, to a skeptical reader, pervasive appeals to bio-inspiration can come across as an instance of the naturalistic fallacy \citep{wortmann2020does,sorensen2015metaheuristics}.
...
In response to these concerns, some have called for de-emphasizing the evolutionary metaphor as a path to deepening and diversifying first principles footing \citep{moore2023evolution}.
...
Here, we highlight how leaning \textit{deeper} into the evolutionary metaphor provides a complementary path toward strengthening the foundations of population-based search methods.
...
While its true that certain particulars are of limited general applicability, owing to practical needs to incorporate abstractions for tractability and generalizability across domains of biological life, we have found there to be a good amount of work that is useful to evolutionary computation.
...
Therefore, any systematic theory generalizable across evolutionary computation would likely also hold substantial explanatory power for aspects of biology and vice verse.
