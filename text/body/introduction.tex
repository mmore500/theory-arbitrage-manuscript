...
The natural world's complexity and emergent intelligence present an irresistable display of evolution's profound creative power, and the prospect of capturing any fraction of such capability is fascinating.
...
The charisma of bio-inspiration, however, has also imparted preoccupying distractions within EC \citep{moore2023evolution,sorensen2013metaheuristics,aranha2021metaphorbased,campelo2023lessons}.
...
One proposed path forward is to de-emphasize the evolutionary metaphor, in order to deepen and diversify alternative first-principles footing for EC \citep{moore2023evolution}.
While we agree that EC needs sounder theory, we propose the opposite --- that a concurrent effort should also approach the field's challenges by leaning further into the evolutionary metaphor, in a new direction.
...
We argue one step further should be taken: gathering inspiration from the science arising around biology, rather than just the biology itself.
Using such existing bioscience can help improve understanding of how and why EC algorithms work, not just improve their performance.
...
Particularly notable is the subfield of experimental evolution, which instantiates evolution under controlled conditions \citep{kawecki2012experimental} --- much the same as EC.
In the case of so-called ``directed evolution'' experiments, evolutionary optimization can even be explicitly recruited to a desired objective \citep{cobb2013directed,carroll2014applying}.
...
Translated bioscience has already made important impacts in EC (Table \ref{tab:arbitrage-examples}), as we review across five themes:
...
This said, a fundamental difference can arise in the capability for digital evolution to abstract away otherwise immutable pillars of biology (e.g., environmental heterogeneity, phenotypic plasticity, fitness stochasticity, etc.) \citep{belew1996computation}.
While it must be accounted for, this capacity of digital evolution can actually be leveraged to complement biological study systems in certain areas \citep{dolson2021digital}, a point we return to in our concluding remarks.
Despite such reciprocal exchange the smaller field of EC should not expect to rival the breadth and depth of biology alone, an ultimate motivation for the need to borrow.
...
With such expanded perspective, bio-inspiration can go beyond producing new EC techniques, to also help explain how and why they work.
