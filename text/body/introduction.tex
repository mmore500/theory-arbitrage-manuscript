...
In addition to arguing that they impart useful new ideas, some highlight value from biological metaphors simply as a source for convenient, intuitive, self-consistent vocabulary \citep{sorensen2015metaheuristicsthe, banzhaf2006from}.
...
Indeed, the demonstrated viability of natural precedent lends bio-inspiration credence as a blueprint for ambitious research agendas in computing \citep{miikkulainen2021a, banzhaf2006fromb}.
...
Historically, evolutionary computation researchers have primarily drawn on bio-inspiration to improve the performance of runtime algorithms \citep{banzhaf2006from, kumar2003biologically, mcphee2009developmental}.
...
As we will review, substantial progress has already been made in this vein \citep{hu2010evolvabilityd} --- however, much untapped value remains to be ``arbitraged'' from biological literature.
