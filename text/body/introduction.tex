...
Indeed, given the prevalence of bio-inspiration within evolutionary computing (EC), its merit has constituted a longstanding point of discussion.
...
Further, the demonstrated viability of natural precedent lends bio-inspiration manifest credence as a blueprint for ambitious research agendas in computing \citep{miikkulainen2021biological,banzhaf2006from}.
...
Indeed, computational artificial life approaches, a close cousin of evolutionary computation, are a popular technique for exploring the generalizability of biological findings beyond life-as-we-know-it is \citep{cleland2013general,langton1989artificial,pennock2007models}. % ELD: Lots more astrobiology citations we could add here
...
Despite limitations of biological analysis and theory, arbitrage from biology seems likely to account for a substantial fraction of what explanatory power is possible within EC.
