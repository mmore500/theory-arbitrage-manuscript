...
Indeed, given the prevalence of bio-inspiration within EC, the merit of biological metaphors has constituted a longstanding point of discussion.
In addition to arguing that they impart useful new ideas, some highlight value from biological metaphors simply as a source for convenient, intuitive, self-consistent vocabulary \citep{sorensen2013metaheuristics,banzhaf2006artificial}.
Another draw of bio-inspiration is the charisma it lends evolutionary computation \citep{lehman2020surprising}.
The complexity and emergent intelligence found throughout the natural world provide a stunning display of evolution's profound creative power, and the prospect of capturing any fraction of that power and creativity is fascinating.
...
Indeed, the demonstrated viability of natural precedent lends bio-inspiration credence as a blueprint for ambitious research agendas in computing \citep{miikkulainen2021biological,banzhaf2006artificial}.

Some have questioned, however, whether the charisma of the bio-inspired framing might also be serving as a preoccupying distraction \citep{moore2023evolution,sorensen2013metaheuristics,aranha2021metaphorbased,campelo2023lessons,camachovillaln2022exposing}.
In particular, given the broader tendency for machine learning researchers to adhere to their preferred models \citep{domingos2012few}, there is risk that evolutionary approaches have become something of a pursuit for its own sake, rather than a means to an end \citep{woodward2016gp,yampolskiy2018why}.
...
Moreover, to a skeptical reader, pervasive appeals to bio-inspiration can come across as window dressing on recycled ideas or as an instance of the naturalistic fallacy \citep{wortmann2020does,sorensen2013metaheuristics}.
...
One possible response to these concerns is to favor de-emphasizing the evolutionary metaphor, with the goal of deepening and diversifying the first principles footing of evolutionary computation \citep{moore2023evolution}.
...
As we will review, substantial progress has already been made in this vein \citep{hu2010evolvability} --- however, much untapped value remains to be ``arbitraged'' from biological literature.
