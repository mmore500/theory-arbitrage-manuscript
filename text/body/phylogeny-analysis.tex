...
\begin{itemize}
  ...
  \item What can phylogenetic metrics tell us about useful diversity in evolutionary algorithms? \citep{hernandez2022what}
  ...
  \begin{itemize}
    ...
    \item MODES \citep{dolson2019the}
  \end{itemize}
\end{itemize}

TODO lead-in goes here

\input{text/body/phylogeny-analysis/example.tex}
