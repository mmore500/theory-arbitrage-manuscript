...
\toprule
\textbf{EC Mechanism} & \textbf{Bioscience Concept} & \textbf{References} \\
\midrule
...
Inexact referencing (e.g., tags) & Active-site recognition & \citep{spector2011tag,moreno2023matchmaker,lalejini2018signalgp,downing2015intelligence} \\
...
Indirect encodings & Transcription and translation & TODO \\
\bottomrule
\end{tabular}
\end{table}

% Other ideas:
% - Mechanisms related to bloat? Harder to match bloat control with bio process? Genome size evolution?
% - ...
